    ...
    handlers: {
      ...
      DELETE: async ({ request }) => {
        try {
          ...
          return Response.json({ error: err instanceof Error ? err.message : "Could not consume job." }, { status: 500 });
        }
      },
    },
  },
